...
import com.google.gerrit.client.auth.Authentication;
import com.google.gerrit.client.auth.HttpBasicAuth;
import com.google.gerrit.client.auth.HttpBearerAuth;
import com.google.gerrit.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://gerrit-review.googlesource.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://{host}",
      "Anonymously accessible endpoints.",
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/3.15.0-SNAPSHOT/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://gerrit-review.googlesource.com)
     ...
     * @return a {@link com.google.gerrit.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.google.gerrit.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.google.gerrit.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.google.gerrit.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.google.gerrit.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.google.gerrit.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.google.gerrit.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.google.gerrit.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.google.gerrit.client.ApiException If fail to serialize the request body object into a string
     */
