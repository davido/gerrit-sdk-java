...
public class MenuEntry {
  ...
  public MenuEntry name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public MenuEntry items(@javax.annotation.Nullable List<MenuItem> items) {
    this.items = items;
    return this;
  }

  public MenuEntry addItemsItem(MenuItem itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, menuEntry.name) &&
        Objects.equals(this.items, menuEntry.items);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "items"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MenuEntry.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MenuEntry is not found in the empty JSON string", MenuEntry.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MenuEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MenuEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
